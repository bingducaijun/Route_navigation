package com.mstarc.plus.route_navigation.base;
...
import com.mstarc.plus.route_navigation.R;
import com.mstarc.plus.route_navigation.util.ErrorInfo;
import com.mstarc.plus.route_navigation.util.TTSController;
...
public class BaseActivity extends Activity implements AMapNaviListener, AMapNaviViewListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		sList.add(myApp.currLocation);
		eList.add(myApp.tarLocation);
	}
